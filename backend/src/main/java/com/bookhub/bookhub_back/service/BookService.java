...
public interface BookService {
    ResponseDto<BookResponseDto> createBook(BookCreateRequestDto dto, String loginId, MultipartFile coverImageFile) throws Exception;
    ResponseDto<BookResponseDto> updateBook(String isbn, BookUpdateRequestDto dto, String loginId, MultipartFile newCoverImageFile) throws Exception;
