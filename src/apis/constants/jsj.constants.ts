...
export const GET_PURCHASE_ORDER_APPROVAL_URL = (approvedDateAt: Date, employeeId: number, isApproved: boolean, purchaseOrderId: number) => `${PURCHASE_APPROVAL_MODULE_URL}?approvedDateAt=${approvedDateAt}&employeeId=${employeeId}&isApproved=${isApproved}&purchaseOrderId=${purchaseOrderId}`;
