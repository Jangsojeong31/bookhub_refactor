...
//       <h2 style={{ marginBottom: '24px' }}>재고 로그 메인</h2>
//       <div className="button-group">
//         <button className="stock-button" onClick={() => navigate(`/stock-logs/branch/${branchId}`)}>재고 전체 조회</button>
//         <button className="stock-button" onClick={() => navigate(`/stock-logs/branch/${branchId}/type`)}>유형별 조회</button>
//         <button className="stock-button" onClick={() => navigate(`/stock-logs/branch/${branchId}/date`)}>날짜별 조회</button>
//         <button className="stock-button" onClick={() => navigate(`/stock-logs/employee/${employeeId}`)}>사원별 조회</button>
//         <button className="stock-button" onClick={() => setShowModal(true)}>도서별 조회</button>
//       </div>
//       {showModal && (
//   <div
//     style={{
