import { getDailySalesQuantity, getSalesQuantityByBranch } from '@/apis/statistics/salesQuantityStatistics/salesQuantityStatistics';
...
function DailySalesQuantity() {
  ...
  return (
    <div style={{ width: "100%", maxWidth: 1400, margin: "0 auto", padding: 32 }}>
      <h4>일일 통계</h4>
